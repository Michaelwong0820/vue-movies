<template>
  <div>
      ...
      <div class="flex-box">
        <div class="left">
          <div class="top">
            ...
            <div v-else
                 class="star-box">
              <div v-for="(item,index) in movieInfo.starArr"
                   :key="index">
                <img v-if="item===1"
                     src="@/assets/imgs/full.png" />
                <img v-else-if="item===3"
                     src="@/assets/imgs/halfStar.jpg" />
                <img v-else
          ...
          <div class="bottom">
            ...
            <span v-for="genre in movieInfo.genres"
                  :key="genre">{{genre}} /</span>
            {{movieInfo.durations && movieInfo.directors[0].name}}(导演) /
            <span v-for="cast in movieInfo.casts"
                  :key="cast.id">{{cast.name}} /</span>
    ...
    <div class="channel-box">
      ...
      <div class="tag-box">
        <div v-for="tag in movieInfo.tags"
             :key="tag">
          {{tag}}
    ...
    <div class="movie-desc">
      ...
      <div class="scroll-view">
        ...
        <div v-for="cast in movieInfo.casts"
             :key="cast.id"
             class="item">
    ...
    <!-- 预告片&图片 -->
    <div class="movie-desc">
      <div class="title small">{{movieInfo.title}}的预告片({{movieInfo.trailers && movieInfo.trailers.length}})、视频评论(1)和图片({{movieInfo.photos_count}})</div>
      <!-- 滚动区域 -->
      <div class="scroll-view">
        <div v-for="trailer in movieInfo.trailers"
             :key="trailer.id"
             class="video-item">
          <video :src="trailer.resource_url"
                 controls></video>
        </div>
      </div>
    </div>
    ...
    <div class="comment-box">
      ...
      <div v-for="comment in movieInfo.popular_comments"
           :key="comment.id"
           class="section">
        <div class="left">
